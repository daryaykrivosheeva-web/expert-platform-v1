          ...
          {whyTrust.items.map((item, i) => {
            ...
            return (
              <Reveal key={item.title} delay={i * 0.05}>
                <div className="group h-full rounded-3xl border border-charcoal bg-ash-gray p-8 transition-all duration-300 hover:-translate-y-1 hover:border-ink hover:shadow-lift">
                  <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-obsidian text-volt transition-colors duration-300 group-hover:bg-volt group-hover:text-ink">
