...
export function Process() {
  ...
  return (
    <section id="process" className="bg-ash-gray py-20 sm:py-28">
      <Container>
        ...
        >
          <motion.div
            ...
            className="absolute left-0 right-0 top-6 hidden h-px bg-charcoal lg:block"
          />
          {process.steps.map((step, i) => (
            <Reveal key={step.title} delay={i * 0.1} className="relative">
              <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-obsidian font-heading text-lg font-bold text-volt shadow-soft">
                {i + 1}
              </div>
