 ...
 *
 * Домен (daryaradchenko.ru), юридическое ФИО и остальные данные — реальные.
 */
    ...
    items: [
      {
        ...
        description:
          "Продающий сайт под ключ — от идеи до запуска. Не просто красивая картинка, а инструмент, который помогает получать заявки и выглядеть профессионально.",
        price: "15 000 ₽",
      ...
      },
      {
        title: "Лид-магнит",
        description:
          "PDF, чек-лист или мини-книга, которые превращают случайных посетителей в подписчиков и клиентов.",
        price: "от 10 000 ₽",
        duration: "Срок — по договорённости",
        features: [
      ...
      },
      {
        ...
        description:
          "Готовый контент-план на месяц: что публиковать, когда и зачем — без ежедневного мозгового штурма.",
        price: "20 000 ₽ / месяц",
        duration: "Ежемесячный пакет",
        features: [
      ...
      },
      {
        title: "Telegram-бот",
        description:
          "Бот, который отвечает клиентам вместо вас: принимает заявки, отвечает на частые вопросы, выдаёт материалы.",
        price: "8 000 ₽",
        duration: "Срок — по договорённости",
        features: [
      ...
      {
        title: "Рабочее пространство в Notion",
        description:
          "Личный кабинет для вашей работы: клиенты, задачи и финансы — в одном месте, без десятка разрозненных таблиц.",
        price: "10 000 ₽",
        duration: "Срок — по договорённости",
      ...
      },
      {
        title: "AI-сотрудники",
        description:
          "Готовый цифровой помощник, настроенный под вашу нишу — экономит часы рутинной работы каждую неделю.",
        price: "от 2 990 ₽",
        duration: "Срок — по договорённости",
        features: [
