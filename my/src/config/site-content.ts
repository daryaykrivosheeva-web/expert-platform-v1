 ...
 *
 * Визуальная система — Osmo (см. DESIGN.md, загруженный в чат): концретно-
 * серый холст, три акцентных цвета (Volt/Ultraviolet/Vermillion), острые
 * 5px-радиусы на карточках против предельно круглых кнопок/бейджей.
 *
 ...
 *
 * ЦЕНЫ: в присланном DESIGN-брифе цены на услуги отличаются от того, что
 * мы согласовали чатом чуть раньше (сайт — 35 000 ₽ вместо 15 000 ₽,
 * Telegram-бот и Notion — снова "от 20 000 ₽" вместо фиксированных
 * 8 000 ₽ / 10 000 ₽). Здесь применены цены ИЗ БРИФА как более свежего и
 * подготовленного документа — проверь, что это действительно то, что
 * нужно, а не старая версия текста.
 */
const siteContent: SiteConfig = {
  ...
  expert: {
    ...
    bio: [
      "Создаю современные цифровые решения для экспертов и небольшого бизнеса.",
  ...
  nav: [
    ...
    { label: "Что я могу сделать", href: "#services" },
  ...
  hero: {
    ...
    headline: "Сайт, который помогает",
    highlight: "получать клиентов",
    subheadline:
      "Разрабатываю быстрые современные сайты под ключ. При необходимости помогу создать лид-магнит, Telegram-бота, CRM в Notion, AI-сотрудника и другие цифровые инструменты для развития вашего проекта.",
  ...
  about: {
    ...
    paragraphs: [
      "Меня зовут Дарья Радченко.",
      "Я создаю современные цифровые решения для экспертов и небольшого бизнеса.",
      "Для меня важно сделать не просто красивый сайт, а удобный инструмент, который будет помогать привлекать клиентов и экономить ваше время.",
    ],
    photo: "/images/about.jpg",
    highlights: [
      { icon: "Sparkles", text: "Слежу за современными трендами" },
      { icon: "Target", text: "Разработка под вашу задачу" },
      { icon: "ShieldCheck", text: "На связи на всех этапах работы" },
      { icon: "TrendingUp", text: "Можно развивать проект дальше" },
    ],
  },

  services: {
    heading: "Что я могу сделать",
    subheading: "Сайт — основа. Остальное — продолжение, когда будет нужно.",
    items: [
      {
      ...
      {
        title: "Лид-магниты",
        description: "PDF, чек-листы, мини-книги, гайды, тесты.",
        price: "от 10 000 ₽",
        duration: "Срок — по договорённости",
        features: [
          "PDF-документ или чек-лист",
          "Продуманная структура и подача",
          "Оформление в вашем стиле",
          "Готов к публикации в соцсетях и на сайте",
        ],
        ctaText: "Обсудить проект",
      },
      {
        title: "Контент для социальных сетей",
        description: "Контент-план, Reels, карусели, хуки.",
        price: "от 20 000 ₽",
        duration: "Срок — по договорённости",
        features: [
      ...
      },
      {
        ...
        duration: "Срок — по договорённости",
        features: [
          "Приём и запись заявок",
          "Ответы на частые вопросы",
          "Автоматическая выдача материалов",
          "Настройка под ваши сценарии",
        ],
        ctaText: "Обсудить проект",
      },
      {
        title: "Рабочее пространство Notion",
        description: "CRM, финансы, клиенты, задачи, проекты.",
        price: "от 20 000 ₽",
        duration: "Срок — по договорённости",
        features: ["База клиентов", "Задачи и календарь", "Учёт финансов", "Настройка под ваши процессы"],
        ctaText: "Обсудить проект",
      },
      {
        title: "AI-помощники",
    ...
    items: [
      {
        ...
        description: "Каждый сайт собираю под конкретную задачу — без шаблонных решений.",
      },
      {
        icon: "Sparkles",
      ...
      {
        icon: "Smartphone",
        title: "Отличная работа на телефоне",
      ...
      {
        icon: "TrendingUp",
        title: "Возможность масштабирования проекта",
    ...
    rows: [
      {
        ...
        ownSite: "Нет постоянной абонентской платы",
        builder: "Обычно требуется ежемесячная или ежегодная подписка",
      },
      {
        label: "Права на сайт",
        ownSite: "Полностью принадлежит владельцу",
        builder: "Зависимость от платформы",
      },
      {
        label: "Скорость",
        ownSite: "Максимальная скорость",
        builder: "Ограничения конструктора",
      },
      {
        label: "Доработки",
        ownSite: "Можно дорабатывать под любые задачи",
        builder: "Ограниченные возможности",
      },
      {
        label: "Техническая база",
        ownSite: "Современный код",
        builder: "Работа внутри готовых блоков",
      },
    ],
    footnote:
      "Самописный сайт — это долгосрочное вложение в ваш бизнес. Вы один раз инвестируете в разработку и получаете собственный цифровой актив, который можно развивать без ограничений.",
  },
  ...
  process: {
    ...
    steps: [
      ...
      { title: "Изучаю ваш проект", description: "Погружаюсь в специфику вашей ниши и аудитории." },
      { title: "Разрабатываю решение", description: "Собираю сайт: дизайн, вёрстку и наполнение." },
      { title: "Вносим правки", description: "Смотрите готовый вариант и присылаете замечания." },
      { title: "Запускаем проект", description: "Публикуем сайт и передаю вам все доступы." },
    ],
  },

  addOns: {
    heading: "После запуска сайта",
    subheading: "Можно постепенно добавить:",
    items: [
      { icon: "Bot", label: "Telegram-бот" },
      { icon: "FileText", label: "лид-магнит" },
      { icon: "LayoutGrid", label: "CRM" },
      { icon: "Brain", label: "AI-помощников" },
      { icon: "Zap", label: "автоматизацию процессов" },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Да, сайт легко развивать: можно добавить лид-магнит, Telegram-бота, CRM или другие инструменты.",
      },
      {
  ...
  legal: {
    ...
    entityName: "Радченко Дарья Олеговна",
    inn: "282514212660",
