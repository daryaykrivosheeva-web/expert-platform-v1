...
Материалы клиента (бриф, исходные фото) и краткое summary проделанной работы:

`../Клиенты/<Клиент>/`

Полная коммерческая карточка клиента (статус, история проекта, задачи) ведется отдельно, в студийном репозитории `AI-Product-Studio/13_Clients/CLIENT-XXX_Имя/`.
