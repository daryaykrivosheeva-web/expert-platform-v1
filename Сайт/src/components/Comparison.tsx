            ...
            <table className="w-full min-w-[560px] border-collapse text-sm">
              <thead>
                <tr className="border-b border-border">
                  <th className="w-1/3 px-6 py-5 text-left font-heading text-sm font-semibold text-muted sm:px-8">
                    &nbsp;
                  </th>
                  <th className="px-4 py-5 text-left font-heading text-base font-semibold text-ink">
                    {comparison.ownSiteLabel}
                  </th>
                  <th className="px-4 py-5 text-left font-heading text-base font-semibold text-muted sm:pr-8">
              ...
              <tbody>
                {comparison.rows.map((row, i) => (
                  <tr
                    key={row.label}
                    className={i < comparison.rows.length - 1 ? "border-b border-border" : ""}
                  >
                    <td className="px-6 py-5 text-sm font-medium text-muted sm:px-8">
                      {row.label}
                    </td>
                    ...
                    <td className="px-4 py-5 text-sm text-muted sm:pr-8">
                      <span className="flex items-start gap-2">
