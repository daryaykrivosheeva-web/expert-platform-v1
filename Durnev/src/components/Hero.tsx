    ...
    <section id="hero" className="relative overflow-hidden bg-paper pt-32 pb-20 sm:pt-40 sm:pb-28 lg:pt-44">
      <Container className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
        <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.1 } } }}>
          <motion.p variants={item} className="text-xs font-semibold uppercase tracking-[0.2em] text-gold sm:text-sm">
            {HERO.eyebrow}
          </motion.p>
          ...
          <motion.div variants={item} className="mt-10 flex flex-col gap-4 sm:flex-row">
            <CTAButton href="#offer" variant="solid">
              Бесплатный протез
            </CTAButton>
        ...
        <div className="relative">
          <PhotoFrame image={IMAGES.hero} priority frame="portrait" className="lg:aspect-[4/5]" />
        </div>
      </Container>
    </section>
  );
