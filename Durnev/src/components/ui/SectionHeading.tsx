...
export default function SectionHeading({
  ...
  return (
    <div className={`${align === "center" ? "text-center mx-auto" : ""} ${className}`}>
      ...
      <Reveal delay={0.05}>
        <h2
          className={`mt-4 text-balance text-[28px] leading-[1.15] sm:text-[36px] lg:text-[42px] ${
      ...
      {subtitle && (
        <Reveal delay={0.1}>
          <p
            className={`mt-5 max-w-2xl text-balance text-lg leading-relaxed normal-case sm:text-xl ${
