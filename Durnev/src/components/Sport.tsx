    ...
    <section id="sport" className="bg-paper-alt py-20 sm:py-28">
      <Container>
        <SectionHeading
          ...
          title="Жизнь после ранения — это спорт, а не карантин"
          subtitle="Волейбол сидя, зал, бассейн, велосипед, эндуро и Эльбрус — ранение не помешало ни одному из этих увлечений."
        />
